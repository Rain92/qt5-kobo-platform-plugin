...
enum WaveForm
{
    ...
    WaveForm_GC16 = WAVEFORM_MODE_GC16,
    ...
    WaveForm_GC4 = WAVEFORM_MODE_GC4,
    ...
    WaveForm_GL16 = WAVEFORM_MODE_GL16,
    ...
    // modes.
    WaveForm_REAGLD = WAVEFORM_MODE_REAGLD
